 ...
 */
@WebServlet("/newExpenseModal")
public class newExpenseModal extends HttpServlet {
	...
	protected void getModal() {
		eredmeny += "<div class=\"modal\" id=\"newExpense\" tabindex=\"-1\" role=\"dialog\"\r\n"
				...
				+ "						onclick=\"saveExpense('0')\">Mentés</button>\r\n" + "				</div>\r\n"
				+ "			</div>\r\n" + "		</div>\r\n" + "	</div>";
	}

	protected String modalBody() {
		String eredmeny = "<form>\r\n"
				+ "  <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\"><input name=\"name\" class=\"mdl-textfield__input\" id=\"name\" type=\"text\"><label class=\"mdl-textfield__label\" for=\"name\">Név</label></div>\r\n"
				+ "  <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-dirty\"><input name=\"value\" class=\"mdl-textfield__input\" pattern=\"-?[0-9]*(\\.[0-9]+)?\" id=\"value\" type=\"text\" value=\"0\"><label class=\"mdl-textfield__label\" for=\"value\">Összeg</label><span class=\"mdl-textfield__error\">Számot adj meg!</span></div>\r\n"
				+ "  <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-dirty\"><input name=\"date\" class=\"mdl-textfield__input\" id=\"date\" type=\"date\" value=\""
				+ LocalDate.now() + "\"><label class=\"mdl-textfield__label\" for=\"date\">Dátum</label></div>\r\n"
				+ "  <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\"><input name=\"note\" class=\"mdl-textfield__input\" id=\"note\" type=\"text\"><label class=\"mdl-textfield__label\" for=\"note\">Megjegyzés</label></div>\r\n"
				+ "  <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label>\r\n"
				+ "<input name=\"date\" class=\"mdl-textfield__input\" id=\"date\" type=\"date\"/>"
